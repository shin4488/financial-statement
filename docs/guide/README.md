...
| 02 | [プロダクト仕様](02_product.md) | Webガイドにない検索・データ更新・表示の補足仕様 | 全員 |
...
| 04 | [システム](04_system.md) | 開発環境の構成・取込ジョブの信頼性・公開APIの防御・一覧画面の実装 | 実装を触る人 |
| 05 | [開発と運用](05_development_operations.md) | 変更時の検証・再取込・本番構成・デプロイ・監視とリカバリ | 開発・運用に関わる人 |

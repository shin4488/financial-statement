...
このリポジトリ（investee）のドキュメントの本体。**01〜05を番号順に読む**と、前提知識ゼロから設計・運用まで理解できる。06〜07は作業のときに引く資料。
...
| 07 | [使っていないが残しているもの](07_unused_but_kept.md) | 【資料】削除済みの旧系統凍結データ `security_reports` の復元手段と、旧系統の名残に見えるが削除してはいけないもの | 何かを削除してよいか判断するとき |
